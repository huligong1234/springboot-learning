...
public class AppController {
    ...
    @GetMapping("/all")
    public Response<Iterable<App>> findAll(){
    ...
    public Response<Page<App>> findPage(Pageable pageable,
    		@RequestParam(value="searchContent",required=true, defaultValue="") String searchContent){
    	Page<App> result = appService.findPage(pageable,searchContent);
    ...
    public Response<String> addOne(AppForm appForm){
    	...
    	if(null == savedApp || null == savedApp.getId() || savedApp.getId()<=0) {
